...
Variable : Type ProdID {printf("[Reduce %i%s", yyn, "]");}
	 ;
...
FunctionDecl : Type ProdID _leftparen Formals _rightparen StmtBlock {printf("[Reduce %i%s", yyn, "]");}
	 | _void ProdID _leftparen Formals _rightparen StmtBlock        {printf("[Reduce %i%s", yyn, "]");}
	 ;
...
ClassDecl : _class ProdID extend implement _leftbrace Fields _rightbrace {printf("[Reduce %i%s", yyn, "]");}
     ;
...
ids : ProdID               {printf("[Reduce %i%s", yyn, "]");}
	| ids _comma ProdID    {printf("[Reduce %i%s", yyn, "]");}
	;

InterfaceDecl : _interface ProdID _leftbrace Prototypes _rightbrace {printf("[Reduce %i%s", yyn, "]");}
	 ;
...
Prototype : Type ProdID _leftparen Formals _rightparen _semicolon {printf("[Reduce %i%s", yyn, "]");}
	 | _void ProdID _leftparen Formals _rightparen _semicolon     {printf("[Reduce %i%s", yyn, "]");}
	 ;
...
/*Shift-Reduce */
Lvalue : ProdID 					{printf("[Reduce %i%s", yyn, "]");} 
...
Call : ProdID _leftparen Actuals _rightparen {printf("[Reduce %i%s", yyn, "]");}
	 | ProdID ProdPDANDID _leftparen Actuals _rightparen             {printf("[Reduce %i%s", yyn, "]");} 
	 ;
